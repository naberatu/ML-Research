...
def image_dataset_from_directory(directory,
  ...
  keras_dataset_utils.check_validation_split_arg(
      validation_split, subset, shuffle, seed)

  if seed is None:
    seed = np.random.randint(1e6)
  image_paths, labels, class_names = keras_dataset_utils.index_directory(
      directory,
      labels,
  ...
  image_paths, labels = keras_dataset_utils.get_training_or_validation_split(
...
def paths_and_labels_to_dataset(image_paths,
  ...
  if label_mode:
    label_ds = keras_dataset_utils.labels_to_dataset(labels, label_mode, num_classes)
